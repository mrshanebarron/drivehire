...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Candidates
        $candidates = [
            ['first_name' => 'Marcus', 'last_name' => 'Chen', 'email' => 'marcus.chen@email.com', 'phone' => '(614) 555-0142', 'location' => 'Columbus, OH', 'headline' => 'ASE Master Technician | BMW & Mercedes Specialist | 12 Years', 'summary' => 'Master technician with over 12 years of experience specializing in European vehicle platforms. Currently working at a BMW dealership but looking for a leadership role where I can mentor junior techs while continuing hands-on diagnostic work.', 'experience_years' => 12, 'skills' => json_encode(['ASE Master', 'BMW', 'Mercedes-Benz', 'ADAS Calibration', 'EV/Hybrid', 'Diagnostic', 'ISTA']), 'certifications' => json_encode(['ASE Master Technician', 'BMW Factory Trained', 'EPA 608']), 'availability' => '2-weeks', 'source' => 'linkedin', 'desired_salary' => '$95K-$105K'],
            ['first_name' => 'Sarah', 'last_name' => 'Blackwood', 'email' => 'sarah.blackwood@email.com', 'phone' => '(402) 555-0198', 'location' => 'Omaha, NE', 'headline' => 'Heavy Equipment Specialist | CAT Certified | 8 Years Field Experience', 'summary' => 'Field service technician specializing in Caterpillar heavy equipment. Experienced with everything from skid steers to mining haul trucks. I thrive in challenging field conditions.', 'experience_years' => 8, 'skills' => json_encode(['Caterpillar', 'Hydraulics', 'Diesel', 'Welding', 'Electrical', 'CDL Class A']), 'certifications' => json_encode(['CAT ThinkBIG Graduate', 'CDL Class A', 'MSHA Certified']), 'availability' => 'immediate', 'source' => 'indeed', 'desired_salary' => '$80K-$90K'],
            ['first_name' => 'James', 'last_name' => 'Rodriguez', 'email' => 'j.rodriguez@email.com', 'phone' => '(404) 555-0267', 'location' => 'Atlanta, GA', 'headline' => 'Collision Repair Estimator | I-CAR Platinum | CCC ONE Expert', 'summary' => 'Experienced collision estimator with I-CAR Platinum individual certification. Expert in CCC ONE and Mitchell. Consistent supplement approval rate of 94%.', 'experience_years' => 6, 'skills' => json_encode(['CCC ONE', 'Mitchell', 'DRP Programs', 'Supplements', 'OEM Procedures', 'Customer Relations']), 'certifications' => json_encode(['I-CAR Platinum Individual', 'ASE B6']), 'availability' => '2-weeks', 'source' => 'referral', 'desired_salary' => '$70K-$80K'],
            ['first_name' => 'Emily', 'last_name' => 'Torres', 'email' => 'emily.torres@email.com', 'phone' => '(503) 555-0334', 'location' => 'Portland, OR', 'headline' => 'Marine & Industrial Diesel | Cummins Certified | 5 Years', 'summary' => 'Diesel technician with experience across marine, generator, and heavy-duty truck applications. Cummins Certified Master Mechanic.', 'experience_years' => 5, 'skills' => json_encode(['Cummins', 'Diesel', 'Marine Engines', 'Generators', 'Electrical', 'Troubleshooting']), 'certifications' => json_encode(['Cummins Master Mechanic', 'TWIC Card', 'EPA 608']), 'availability' => 'immediate', 'source' => 'direct', 'desired_salary' => '$70K-$85K'],
            ['first_name' => 'David', 'last_name' => 'Park', 'email' => 'david.park@email.com', 'phone' => '(614) 555-0455', 'location' => 'Dublin, OH', 'headline' => 'Senior Service Advisor | CDK Expert | $2M+ Monthly Revenue', 'summary' => 'Top-performing service advisor with a track record of $2M+ monthly service revenue. Expert in CDK DMS and customer relationship management.', 'experience_years' => 7, 'skills' => json_encode(['CDK', 'Customer Service', 'Upselling', 'DMS Systems', 'Warranty Processing', 'Team Leadership']), 'certifications' => json_encode(['Toyota Service Advisor Certified']), 'availability' => '1-month', 'source' => 'linkedin', 'desired_salary' => '$75K-$85K'],
            ['first_name' => 'Rachel', 'last_name' => 'Kim', 'email' => 'rachel.kim@email.com', 'phone' => '(404) 555-0512', 'location' => 'Decatur, GA', 'headline' => 'ADAS Calibration Specialist | Autel & Hunter Certified | 3 Years', 'summary' => 'Early-career ADAS specialist with certifications from Autel and Hunter. Performed over 800 static and dynamic calibrations.', 'experience_years' => 3, 'skills' => json_encode(['ADAS Calibration', 'Autel ADAS', 'Hunter HawkEye', 'Radar', 'Camera Systems', 'LiDAR']), 'certifications' => json_encode(['Autel ADAS Certified', 'I-CAR ADAS', 'ASE A6']), 'availability' => 'immediate', 'source' => 'direct', 'desired_salary' => '$65K-$85K'],
            ['first_name' => 'Mike', 'last_name' => 'Johnson', 'email' => 'mike.johnson@email.com', 'phone' => '(402) 555-0678', 'location' => 'Lincoln, NE', 'headline' => 'Equipment Sales | $15M Territory | 10 Years B2B', 'summary' => 'Territory sales veteran with 10 years in heavy equipment and industrial sales. Currently managing a $12M territory.', 'experience_years' => 10, 'skills' => json_encode(['B2B Sales', 'Heavy Equipment', 'Territory Management', 'Negotiation', 'CRM', 'Construction Industry']), 'certifications' => json_encode([]), 'availability' => '1-month', 'source' => 'linkedin', 'desired_salary' => '$100K-$130K OTE'],
            ['first_name' => 'Ana', 'last_name' => 'Petrov', 'email' => 'ana.petrov@email.com', 'phone' => '(614) 555-0789', 'location' => 'Westerville, OH', 'headline' => 'F&I Manager | AFIP Certified | $2,800 PVR', 'summary' => 'Experienced Finance & Insurance Manager with AFIP certification and a consistent PVR of $2,800+.', 'experience_years' => 8, 'skills' => json_encode(['F&I', 'DealerTrack', 'RouteOne', 'Compliance', 'Deal Structuring', 'Aftermarket Products']), 'certifications' => json_encode(['AFIP Certified', 'Zurich F&I Trained']), 'availability' => '2-weeks', 'source' => 'referral', 'desired_salary' => '$120K-$150K OTE'],
            ['first_name' => 'Tyler', 'last_name' => 'Brooks', 'email' => 'tyler.brooks@email.com', 'phone' => '(503) 555-0890', 'location' => 'Vancouver, WA', 'headline' => 'Generator & Power Systems Tech | Entry Level | Eager to Learn', 'summary' => 'Recent diesel technology graduate looking to specialize in power generation systems. Completed internship at a Generac dealer.', 'experience_years' => 1, 'skills' => json_encode(['Diesel Engines', 'Generators', 'Electrical Basics', 'PM Service', 'Load Bank Testing']), 'certifications' => json_encode(['Diesel Technology AAS']), 'availability' => 'immediate', 'source' => 'direct', 'desired_salary' => '$24-$28/hr'],
            ['first_name' => 'Lisa', 'last_name' => 'Nguyen', 'email' => 'lisa.nguyen@email.com', 'phone' => '(614) 555-0923', 'location' => 'Columbus, OH', 'headline' => 'Parts Professional | 3 Years Multi-Brand | Inventory Expert', 'summary' => 'Parts counter specialist with experience across Honda, Toyota, and Hyundai dealerships. Known for fast, accurate order fulfillment.', 'experience_years' => 3, 'skills' => json_encode(['Parts Lookup', 'Inventory Management', 'DMS Systems', 'Customer Service', 'Wholesale', 'Shipping/Receiving']), 'certifications' => json_encode(['Honda Parts Certified']), 'availability' => 'immediate', 'source' => 'indeed', 'desired_salary' => '$20-$24/hr'],
        ];
